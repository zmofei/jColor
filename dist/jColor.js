...
var jColor = function () {
    ...
    createClass(jColor, [{
        key: 'set',
        value: function set(color, update) {
        ...
        key: '_setFinalColor',
        value: function _setFinalColor(color, init) {
        ...
        value: function _getColorOnBoard() {
            ...
            // console.log(pos)
            var self = this;
            var topColor = this._getColorOnBar().map(function (color) {
                var setp = 255 - color;
        ...
        key: '_colorToBarLeft',
        value: function _colorToBarLeft(color) {
            var map = {};
